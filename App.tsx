        ...
        <section id="sobre" className="py-12 md:py-24 bg-white border-y border-slate-100 relative overflow-hidden scroll-mt-20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
              ...
              <div className="mt-4 lg:mt-0 text-center lg:text-left flex flex-col items-center lg:items-start">
                ...
                <p className="text-sm md:text-lg text-slate-600 font-light leading-relaxed mb-8 max-w-xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 md:gap-6 w-full max-w-md">
                  {[
                    ...
                    <div key={idx} className="flex items-center lg:items-start space-x-3 group justify-center lg:justify-start">
                      <div className="flex-shrink-0 h-4 w-4 bg-slate-950 flex items-center justify-center rounded-sm group-hover:bg-slate-700 transition-colors">
